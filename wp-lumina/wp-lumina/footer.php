	...
	<footer id="colophon" class="site-footer">
        ...
        <div class="footer-content flex">
           <div class="footer-text">
               <h2><?php echo carbon_get_theme_option('footer_text'); ?></h2>
           </div>
            
        <div class="footer-social-links flex">
      <div class="footer-btn">
                <a href="#" class="button primary"><?php echo carbon_get_theme_option('button_link_book_an'); ?></a>
            </div>
  ...
  <!-- Social Links -->
		...
		<div class="site-info">
			<span class="thanks">
				...
				printf( esc_html__( 'Lumina by Thanks For Today Studio', 'wp-lumina' ), '' );
				?>
			</span>
			<span class="sep"> | </span>
            <span>
				...
				printf( esc_html__( 'Theme: %1$s by %2$s.', ' wp-lumina' ), 'wp-lumina', '<a href="https://dev-websoltan.com/">Viorel Soltan</a>' );
